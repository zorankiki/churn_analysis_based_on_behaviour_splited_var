...
def get_data_for_the_MV_Cox_model(date_of_analysis, spots_set, with_wo_CB, event_date, columns, data_dir, for_the_report = 'yes/no', C = 1, C1 = 1):
    ...
    return (data, base_df, df_timeline)
